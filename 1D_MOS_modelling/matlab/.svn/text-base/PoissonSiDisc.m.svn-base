...
%   This script models a pure semiconductor with a change in permitivvity
%   at x=10e-7. This will allow for comparison with XFEM.
clear all
%close all
clc
...
oxideThickness = 50e-7;  %   Thickness of our oxide
...
ne =100;               %   number of elements in semiconductor
nox = 100;              %   number of elements in oxide
